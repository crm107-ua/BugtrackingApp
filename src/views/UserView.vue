...
export default {
  ...
  methods: {
    obtenerDatosUsuario() {
      axios
        .get(`http://localhost:5000/users?username=${this.username}`)
        .then((response) => {
    ...
    obtenerBugsUsuario() {
      axios
        .get(`http://localhost:5000/bugs?username=${this.username}`)
        .then((response) => {
    ...
    obtenerComentariosUsuario() {
      axios
        .get(`http://localhost:5000/comments?username=${this.username}`)
        .then((response) => {
